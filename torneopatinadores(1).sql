...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2024 at 10:08 PM
...
--
CREATE DATABASE IF NOT EXISTS `torneopatinadores` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `torneopatinadores`;
...
INSERT INTO `profesores` (`id_profesor`, `apellido`, `nombre`, `cargo`) VALUES
(1, 'Kim', 'Young Zah', 'Titular'),
(2, 'Varslovika', 'Lara', 'Suplente'),
(3, 'Staropolis', 'Clara', 'Titular'),
(4, 'Guerra', 'Carlos', 'Suplente');

-- --------------------------------------------------------

--
-- Table structure for table `puntosporaños`
--

DROP TABLE IF EXISTS `puntosporaños`;
CREATE TABLE `puntosporaños` (
  `id_punto` int(11) NOT NULL,
  `patinador_id` int(11) NOT NULL,
  `categoria` varchar(50) NOT NULL,
  `año` int(11) NOT NULL,
  `torneo_id` int(11) DEFAULT NULL,
  `cantidad_participaciones` int(11) DEFAULT 0,
  `puntos_totales` int(11) DEFAULT 0,
  `eficiencia` decimal(5,2) GENERATED ALWAYS AS (case when `cantidad_participaciones` > 0 then `puntos_totales` / `cantidad_participaciones` else 0 end) STORED,
  `sede_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `puntosporaños`
--

INSERT INTO `puntosporaños` (`id_punto`, `patinador_id`, `categoria`, `año`, `torneo_id`, `cantidad_participaciones`, `puntos_totales`, `sede_id`) VALUES
(1, 1, 'Juvenil', 2023, 1, 5, 100, 1),
(2, 5, 'Infantil', 2023, 1, 2, 15, 1),
(3, 9, 'Adulto', 2023, 1, 2, 12, 2),
(4, 10, 'Adulto', 2023, 1, 1, 10, 1),
(5, 12, 'Juvenil', 2023, 1, 1, 15, 1),
(6, 18, 'Senior', 2023, 1, 2, 14, 2),
(7, 2, 'Juvenil', 2023, 1, 4, 60, 1),
(8, 3, 'Juvenil', 2023, 1, 3, 50, 2),
(9, 4, 'Juvenil', 2023, 1, 3, 55, 2),
(10, 6, 'Infantil', 2023, 1, 3, 45, 1),
(11, 7, 'Infantil', 2023, 1, 4, 50, 2),
(12, 8, 'Infantil', 2023, 1, 3, 48, 2),
(13, 11, 'Adulto', 2023, 1, 4, 52, 2),
(14, 13, 'Senior', 2023, 1, 3, 60, 1),
(15, 14, 'Senior', 2023, 1, 3, 58, 2),
(16, 15, 'Master', 2023, 1, 3, 54, 1),
(17, 16, 'Master', 2023, 1, 3, 56, 2),
(18, 17, 'Senior', 2023, 1, 4, 62, 1),
(19, 19, 'Adulto', 2023, 1, 4, 58, 1),
(20, 20, 'Master', 2023, 1, 4, 57, 2);
...
DROP TABLE IF EXISTS `sede_profesores`;
...
INSERT INTO `torneos` (`id_torneo`, `nombre`, `año`, `sede_id`) VALUES
(1, 'Torneo Homenaje a Lucía Fernández', 2023, 1),
(2, 'Torneo Homenaje a Pedro Martínez', 2022, 2),
(3, 'Torneo Homenaje a Sofía Gómez', 2021, 1);
...
--
-- Indexes for table `puntosporaños`
--
ALTER TABLE `puntosporaños`
...
--
-- AUTO_INCREMENT for table `puntosporaños`
--
ALTER TABLE `puntosporaños`
  MODIFY `id_punto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- Constraints for table `puntosporaños`
--
ALTER TABLE `puntosporaños`
  ADD CONSTRAINT `puntosporaños_ibfk_1` FOREIGN KEY (`patinador_id`) REFERENCES `patinadores` (`nro_socio`),
  ADD CONSTRAINT `puntosporaños_ibfk_2` FOREIGN KEY (`torneo_id`) REFERENCES `torneos` (`id_torneo`);
